...
# -----------------------------------------------------
# Visualization — Forecast Comparison (Dark Theme Fixed)
# -----------------------------------------------------
fig = go.Figure()
...
# ✅ Force consistent aesthetic: dark-friendly but readable on both themes
fig.update_layout(
    title=dict(
    ...
    # 🧱 Dark blending background (greyish tone, not pure black)
    plot_bgcolor="#1c1f24",
